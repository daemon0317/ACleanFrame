...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xeffdfdfd,
			0xcffdfdfd, 0x3ffdfdfd };
	 ...
	 * Actual amount of visible items depends onShowError wheel layout parameters.
	...
	/**
	 * Draws shadows onShowError top and bottom of control
