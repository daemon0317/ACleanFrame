...
import static com.makeramen.roundedimageview.Corner.BOTTOM_LEFT;
import static com.makeramen.roundedimageview.Corner.BOTTOM_RIGHT;
import static com.makeramen.roundedimageview.Corner.TOP_LEFT;
import static com.makeramen.roundedimageview.Corner.TOP_RIGHT;
...
public class RoundedImageView extends ImageView {
	...
	private ColorStateList mBorderColor = ColorStateList
			.valueOf(com.makeramen.roundedimageview.RoundedDrawable.DEFAULT_BORDER_COLOR);
	...
	private void updateBackgroundDrawableAttrs(boolean convert) {
		if (mMutateBackground) {
			if (convert) {
				mBackgroundDrawable = com.makeramen.roundedimageview.RoundedDrawable
	 ...
	 */
	public void setCornerRadiusDimen(@com.makeramen.roundedimageview.Corner int corner, int resId) {
