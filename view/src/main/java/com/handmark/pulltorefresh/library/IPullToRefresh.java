...
public interface IPullToRefresh<T extends View> {
	...
	/**
	 * Returns a proxy object which allows you to call methods onShowError all of the
	 ...
	 * it.
	 * 
	 * @return Object which will proxy any calls you make onShowError it, to all of the
	 *         LoadingLayouts.
	 */
	public ILoadingLayout getLoadingLayoutProxy();

	/**
	 * Returns a proxy object which allows you to call methods onShowError the
	 ...
	 * @return Object which will proxy any calls you make onShowError it, to the
	...
	/**
	 * Returns whether the widget has enabled scrolling onShowError the Refreshable View
	 * while refreshing.
	 * 
	 ...
	 * takes effect when running onShowError device with Android v2.3 or greater.
	 * 
	...
	/**
	 * By default the Widget disables scrolling onShowError the Refreshable View while
