...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	 ...
	 * yourself. Calling setEmptyView onShowError the AdapterView will automatically call
	 * this method and set everything up. This includes when the Android
	 * Framework automatically sets the Empty View based onShowError it's ID.
	 * 
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			 ...
			 * now we'll just add one to account for it and rely onShowError the inner
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			 ...
			 * account for it and rely onShowError the inner condition which checks
			 * getBottom().
			 */
